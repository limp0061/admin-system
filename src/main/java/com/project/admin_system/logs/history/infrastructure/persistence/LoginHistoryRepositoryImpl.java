...
import static com.project.admin_system.logs.history.domain.QLoginHistory.loginHistory;
...
import com.project.admin_system.logs.history.domain.LoginHistoryRepositoryCustom;
...
public class LoginHistoryRepositoryImpl implements LoginHistoryRepositoryCustom {
    ...
    public LoginHistoryDetailResponse findLoginHistoryById(Long id) {
        return queryFactory.select(
                        Projections.constructor(LoginHistoryDetailResponse.class,
                                loginHistory.emailId,
                                loginHistory.rawIp,
                                loginHistory.userAgent,
                                loginHistory.deviceName,
