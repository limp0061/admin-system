    ...
    ru: {
      dictionary: {
        ...
        'Align table to the left with text wrapping':
          'Выровнять таблицу по левому краю с обтеканием текстом',
        'Center table with no text wrapping':
          'Выровнять таблицу по центру без обтекания текстом',
        'Align table to the right with text wrapping':
          'Выровнять таблицу по правому краю с обтеканием текстом',
        'Align table to the left with no text wrapping':
          'Выровнять таблицу по левому краю без обтекания текстом',
        'Align table to the right with no text wrapping':
          'Выровнять таблицу по правому краю без обтекания текстом',
        ...
        'No emojis were found matching "%0".':
          'Не найдено ни одного эмодзи, соответствующего "%0".',
        'Keep on typing to see the emoji.':
          'Продолжайте набирать текст, чтобы увидеть эмодзи.',
        ...
        'Please try a different phrase or check the spelling.':
          'Пожалуйста, попробуйте другую фразу или проверьте правописание.',
        Source: 'Источник',
        Insert: 'Вставить',
        Update: 'Обновить',
        Back: 'Назад',
        ...
        'You have no image editing permissions.':
          'У вас нет разрешений на редактирование изображений.',
