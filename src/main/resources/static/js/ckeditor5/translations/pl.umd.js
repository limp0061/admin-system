    ...
    pl: {
      dictionary: {
        ...
        'Align table to the left with text wrapping':
          'Wyrównaj tabelę do lewej z zawijaniem tekstu',
        'Center table with no text wrapping':
          'Wyśrodkuj tabelę bez zawijania tekstu',
        'Align table to the right with text wrapping':
          'Wyrównaj tabelę do prawej z zawijaniem tekstu',
        'Align table to the left with no text wrapping':
          'Wyrównaj tabelę do lewej bez zawijania tekstu',
        'Align table to the right with no text wrapping':
          'Wyrównaj tabelę do prawej bez zawijania tekstu',
        ...
        'Please try a different phrase or check the spelling.':
          'Spróbuj wyszukać inną frazą lub sprawdź poprawność ortograficzną wyszukiwania.',
        Source: 'Źródło',
        Insert: 'Wstaw',
        Update: 'Zaktualizuj',
        Back: 'Wróć',
        ...
        'You have no image editing permissions.':
          'Nie masz uprawnień do edytowania obrazów.',
