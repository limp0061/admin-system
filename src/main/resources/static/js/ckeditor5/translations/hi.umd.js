    ...
    hi: {
      dictionary: {
        ...
        'Align table to the left with text wrapping':
          'टेक्स्ट रैपिंग के साथ तालिका को बाईं ओर संरेखित करें',
        'Center table with no text wrapping':
          'बिना टेक्स्ट रैपिंग वाली केंद्र तालिका',
        'Align table to the right with text wrapping':
          'टेक्स्ट रैपिंग के साथ तालिका को दाईं ओर संरेखित करें',
        'Align table to the left with no text wrapping':
          'बिना टेक्स्ट रैपिंग के तालिका को बाईं ओर संरेखित करें',
        'Align table to the right with no text wrapping':
          'बिना टेक्स्ट रैपिंग के तालिका को दाईं ओर संरेखित करें',
        ...
        'Find an emoji (min. 2 characters)':
          'एक इमोजी ढूंढें (कम से कम 2 अक्षर)',
        'No emojis were found matching "%0".':
          '"%0" से मेल खाता कोई इमोजी नहीं मिला.',
        'Keep on typing to see the emoji.':
          'इमोजी देखने के लिए टाइप करते रहें.',
        'The query must contain at least two characters.':
          'क्वेरी में कम से कम दो अक्षर होने चाहिए.',
        ...
        'Please try a different phrase or check the spelling.':
          'कृपया किन्हीं और शब्दों का इस्तेमाल करें या स्पेलिंग चेक करें.',
        Source: 'सोर्स',
        Insert: 'इंसर्ट',
        Update: 'अपडेट',
        Back: 'वापस जाएँ',
        ...
        'You have no image editing permissions.':
          'आपके पास तस्वीर को एडिट करने की अनुमति नहीं है.',
